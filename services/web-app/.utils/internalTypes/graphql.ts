...
export type GetAccountsQuery = { __typename?: 'Query', getAccounts: { __typename?: 'NotFoundError' } | { __typename: 'QueryGetAccountsSuccess', data: Array<{ __typename?: 'User', username: string, contracts: Array<{ __typename?: 'SmartContract', contractAddress: string }> }> } | { __typename?: 'UnknownError' } };
